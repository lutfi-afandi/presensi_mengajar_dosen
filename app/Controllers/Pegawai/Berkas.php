...
class Berkas extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'isi'   => 'pegawai/berkas/v_list',
            'title' => 'DAFTAR BERKAS',
            'ta'    => $this->ModelTa->getTa(),
            'makul'    => $this->ModelMakul->getMakul(),
            'berkas'    => $this->ModelBerkas->getBerkas_pegawai($id_pegawai),
        ];
        return view('layout/v_wrapper', $data);
        // return view('pegawai/absensi/v_tambah',$data);
    }
    ...
    public function add()
    {
        ...
        if (!$validation) {
            ...
            return redirect()->to(base_url('Pegawai/Berkas'));
        } else {
