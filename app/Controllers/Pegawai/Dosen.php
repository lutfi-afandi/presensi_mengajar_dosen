...
class Dosen extends BaseController
{
    ...
    public function add()
    {
        ...
        if (!$validation) {
            return redirect()->to(base_url('Pegawai/Dosen/tambah'))->withInput()->with('validation', $validation);
        } else {
    ...
    public function update($id_dosen)
    {
        ...
        if (!$validation) {
            return redirect()->to(base_url('Pegawai/Dosen/ubah/' . $id_dosen))->withInput()->with('validation', $validation);
        } else {
    ...
    public function ubah_foto($id_dosen)
    {
        $validation = $this->validate([
            'foto_baru'         => [
                'rules' => 'uploaded[foto_baru]|max_size[foto_baru,5012]|mime_in[foto_baru,image/jpg,image/jpeg,image/gif,image/png]',
                'errors' => [
                    'uploaded'  => 'Pilih Foto terlebih dulu',
                    'mime_in'   => 'format file tidak sesuai',
                    'max_size'  => 'Ukuran gambar maximal 5 MB'
