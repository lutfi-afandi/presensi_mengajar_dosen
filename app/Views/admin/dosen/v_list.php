...
<div class="card">
    <div class="card-header bg-primary">
        ...
        <div class="card-tools">
            <a href="<?= base_url('Admin/Dosen/tambah'); ?>" class="btn btn-success btn-sm" title="Tambah Kelas"><i class="fa fa-plus"></i> add</a>
        </div>
    </div>
    <div class="card-body">
        <?php
        ...
        <div class="table-responsive">
            <table class="table table-xs table-striped  " id="example1">
                    ...
                    foreach ($dosen as $key => $row) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('Admin/Dosen/ubah/' . $row['id_user']); ?>" class="btn btn-warning btn-sm" title="Ubah Profil"><i class="fa fa-edit text-white"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="" action="<?= base_url('Admin/Dosen/ubah_foto/' . $d['id_user']); ?>" method="POST" enctype="multipart/form-data">
