                        ...
                        <tbody class="">
                            ...
                            foreach ($berkas as $key => $row) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-success btn-sm" href="<?= base_url('Admin/Berkas/download/' . $row['id_berkas']); ?>" title="Download file"><i class="fa fa-download"></i></a>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Admin/Berkas/add'); ?>" method="post" enctype="multipart/form-data">
        ...
        function konfimasi(parameter_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?= base_url('Admin/Berkas/delete'); ?>" + "/" + parameter_id;
                }
            })
        }
    </script>
